...
public enum EnumTypeBaseStuff implements IStringSerializable {
	...
	ALUMINIUM(0, "aluminium", 3.0F, 1), COPPER(1, "copper", 3.0F, 1), LEAD(2, "lead", 4.0F, 2), MANGAN(3, "mangan", 3.0F, 1), MERCURY(4, "mercury", 3.0F, 2), NICKEL(5, "nickel", 3.0F, 2), PLATINUM(6, "platinum", 5.0F, 3), SILICIUM(7, "silicium", 3.0F, 2), SILVER(8, "silver", 3.0F, 1), SULPHUR(9, "sulphur", 2.0F, 1), TIN(10, "tin", 3.0F, 1), URAN(11, "uran", 4.0F, 3), ZINC(12, "zinc", 3.0F, 1);
