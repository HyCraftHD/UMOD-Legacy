...
public class RadiotionEntityFx extends EntityFX{
    ...
    protected RadiotionEntityFx(World worldIn, double p_i46351_2_, double p_i46351_4_, double p_i46351_6_, double p_i46351_8_, double p_i46351_10_, double p_i46351_12_)
    {
    ...
    public static class Factory implements IParticleFactory
        {
            ...
            {
                return new RadiotionEntityFx(worldIn, p_178902_3_, p_178902_5_, p_178902_7_, p_178902_9_, p_178902_11_, p_178902_13_);
            }
        }
